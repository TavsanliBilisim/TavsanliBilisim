...
***6 - Oyunlar ve Programlar:***
   ...
   * WhatsApp:
   ...
   Gizli sohbet bölümü ile istediğiniz sohbeti şifreleyip gizleyin.
   WhatsApp'a özel uçak modu ile internetiniz açık olsa bile WhatsApp'ınız offline olsun.
   "Numaraya Mesaj At" seçeneği ile numaraları rehberinize eklemeden WhatsApp'tan mesaj gönderin.
   "AntiDelete" özelliği ile karşı tarafın mesajları ve medyaları silmesini engelleyin hangi mesaj ve medyaları silmek istediğini öğrenin.
   Görüldü gizleme özelliği ile mesajlar siz mesaja cevap vermeden mavi tik olmaz.
   "Yazıyor...", "Kaydediyor..." bildirimlerinizi karşı taraftan gizleyin.
   30 saniyeden uzun videolarınızı sizin için 30'ar saniyeye bölen video kesme eklentisi.
   Durumları gördüğünüzü gizleyin. Durumlara eklenilen tik ile görüldü yapmak istediğiniz durumdaki tik işaretine tıklayın.
   Silinen durumları 24 saat boyunca görmeye devam edin. Silinen durumlar için durumlarda bildirim görünür.
   Durumları tek tıkla indirin video ve resimler indirilir, yazılar ve internet bağlantıları kopyalanır.
   WhatsApp uygulama simgenizi, mesaj bildirim simgenizi, tik işaretlerinizi, sohbet baloncuklarınısı sayısız seçenek arasından siz seçin.
   250 karakter durum yazma özelliği.
   Sizi WhatsApp'tan kimlerin arayabileceğini seçin.
   WhatsApp'ta kimlerin çevrimiçi olduğunu sohbet ekranına girmeden görün ve bildirim alın.
